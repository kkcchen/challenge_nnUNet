...
class ConfigurationManager(object):
    def __init__(self, configuration_dict: dict):
        ...
        if 'architecture' not in self.configuration.keys():
            ...
            elif unet_class_name == 'UnetWithClassifier':
                network_class_name = "nnunetv2.new_architectures.UnetWithClassifier.UnetWithClassifier"
            else:
            ...
            convs_or_blocks = "n_conv_per_stage" if unet_class_name == "PlainConvUNet" or "UNetWithClassifier" else "n_blocks_per_stage"
