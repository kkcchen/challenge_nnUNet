...
from nnunetv2.new_architectures.UnetWithClassifier import UnetWithClassifier
...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        self.UNet_class = UnetWithClassifier
    ...
    def static_estimate_VRAM_usage(patch_size: Tuple[int],
        ...
        """
        Works for PlainConvUNet, ResidualEncoderUNet. Hopefully UnetWithClassifier?
        """
