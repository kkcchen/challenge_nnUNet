...
class nnUNetDataLoader2D(nnUNetDataLoaderBase):
    def generate_train_batch(self):
        ...
        classification_labels = torch.empty((len(selected_keys),), dtype=torch.uint8)
        case_properties = []
        ...
        if self.transforms is not None:
            ...
            return {'data': data_all, 'target': seg_all, "classification_labels": classification_labels, 'keys': selected_keys}

        return {'data': data_all, 'target': seg_all, "classification_labels": classification_labels, 'keys': selected_keys}


if __name__ == '__main__':
    folder = '/home/kchen/UHN-MedImg3D-ML-quiz/datasets/Dataset011_PancreasCancer'
